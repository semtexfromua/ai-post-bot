...
- **Flower потребує tornado < 6.5.** Flower `2.0.1` (останній реліз) не відповідає на HTTP під tornado 6.5 — UI на `:5555` зависає, хоча логи виглядають здоровими. У `pyproject.toml` запінено `tornado>=6.4,<6.5` — з ним дашборд працює; пін можна зняти, щойно вийде новіший Flower.
